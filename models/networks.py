...
def define_G(args, init_type='normal', init_gain=0.02, gpu_ids=[]):
    if args.net_G == 'base_resnet18':
        ...
        net = BASE_Transformer(input_nc=3, output_nc=args.n_class, token_len=4, resnet_stages_num=4,
                             with_pos='learned', enc_depth=1, dec_depth=8)
       ...
       net =  BASE_Transformer_UNet(input_nc=3, output_nc=3, token_len=4, resnet_stages_num=4,
...
class BASE_Transformer_UNet(ResNet_UNet):
    ...
    def _forward_transformer_decoder(self, x, m, layer):
        ...
        if self.with_decoder_pos == 'learned':
            print('size of tensor b ', self.pos_embedding_decoder_layers[layer].shape)
